...
class EpisodeGraphVisualizer:
    ...
    def detect_page_type(self, soup, page_title):
        ...
        if page_content:
            ...
            faction_phrases = [
                ...
                'are the five', 'are the six', 'are the seven',  # Common for groups
        ...
        if infobox:
            ...
            # Character detection (should be secondary to faction detection)
            if any(key in infobox_text for key in ['race', 'class', 'level', 'player']):
                # But not if it also has organizational indicators
    ...
    def validate_page_type(self, soup, expected_type, page_title):
        ...
        if detected_type != 'unknown':
            ...
            if detected_type == expected_type:
                ...
                # Special case: institutions can be location OR faction
                ...
                # Special case: artifact vs object
                ...
                # Special case: artifact/object labeled as faction (e.g., "Torn Banner" the group)
        ...
        if infobox:
            ...
            # Lack of infobox - check page structure
            if expected_type in ['character', 'location', 'faction']:
                # For factions, look for organizational structure in content
    ...
    def fetch_wiki_image(self, node_label, node_type):
        ...
        if clean_label != node_label:
            search_queries.insert(0, clean_label)  # Try clean version first
